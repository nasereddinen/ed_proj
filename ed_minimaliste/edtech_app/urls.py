...
urlpatterns = [
    ...
    path('student/vid/<str:pk>',views.student_vid, name='student_vid'),
    path('note_student',views.student_notes, name='note_student'),
    ...
    path('teacher/Login',views.Login_Teacher, name='teacher_login'),
